...
\usepackage{hyperref}
\hypersetup{
  pdftitle={Continuous Control and Structural Regularization in Multi-Agent Narrative Extraction},
  pdfauthor={Jack Chaudier Gaffney},
  pdfsubject={AI Safety, Narrative Extraction, Context Compression},
  pdfcreator={LaTeX},
}
...
\maketitle
\begin{center}
\small Working Paper (First Draft) -- February 2026\\
...
All experiments are fully deterministic and reproducible from fixed random seeds at \$0.00 compute cost per condition.\footnote{Seeds 1--50 for population experiments. 20-seed subsets for $\alpha$-sweeps. Code and reproducible artifacts: \url{https://github.com/jack-chaudier/dreams}. Live showcase: \url{https://dreams-dun.vercel.app/}.}
