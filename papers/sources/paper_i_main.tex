...
\hypersetup{
  ...
  pdftitle={Tropical Algebra of Endogenous-Pivot Semantics: Absorbing States, Necessity, and the Record-Gap Spectrum},
  pdfauthor={Jack Chaudier Gaffney},
  pdfsubject={AI Safety, Tropical Algebra, Context Compression},
  pdfcreator={LaTeX},
}
...
A stronger categorical statement remains open: whether L2 is the
\emph{initial object} in the category of valid summaries.  More
concretely, one can ask whether every valid, dominance-monotone summary
...
optimality (part~(b)) do not depend on this stronger conjecture.
\end{proof}
...
optimal among valid summaries at the thresholded feasibility level.
Whether it is also the initial object in the category of valid
summaries remains open.
