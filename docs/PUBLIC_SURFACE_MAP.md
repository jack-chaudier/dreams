...
- If the replay witness changes, refresh `results/replay/`, `site/data_miragekit.json`, and the scope language in `site/index.html`, `site/evidence.html`, and `README.md` together.
